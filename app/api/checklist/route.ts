...
import { CHECKLIST_SYSTEM, requireNonEmptyString, ValidationError } from "@/lib/prompts";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const parsed = extractJson<ChecklistResponse>(raw);
...
function handleError(err: unknown) {
  ...
  console.error("Unhandled /api/checklist error:", err);
